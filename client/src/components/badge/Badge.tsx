...
const Badge: React.FC<BadgeProps> = (props) => {
    ...
    if(props.type.toLocaleLowerCase() == 'approved'){
        bg = 'bg-emerald-400/40 border border-emerald-600 text-black'
    } else if (props.type.toLocaleLowerCase() == 'pending'){
        bg = 'bg-yellow-400/40  border border-yellow-400 text-black'
    } else {
        bg = 'bg-red-400/50  border border-red-500 text-black'
    }
    return (
